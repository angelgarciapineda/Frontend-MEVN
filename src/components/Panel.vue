    ...
    <div class="row p-5">
      <div class="col-md-7">
        <b-card bg-variant="light">
          <b-form @submit.prevent="addPanel">
            <b-form-select v-model="selected">
              <b-form-select-option v-for="home of homes" :key="home._id" :value="home">{{home.name}}</b-form-select-option>
            ...
            <b-form-group
              label-cols-lg="3"
              label="Créer un nouveau panneau"
              label-size="lg"
